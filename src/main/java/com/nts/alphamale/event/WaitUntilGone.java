...
public class WaitUntilGone extends Event {

	@Expose
	private int timeout = 1000;
	
	public WaitUntilGone() {
		type = EventType.WAIT_UNTIL_GONE;
		eType = type.toString();
	...
	public String getTitle(){
		String format = "%s %dms (%d)";
		title  = String.format(format, type.toString(), timeout, element.getIndentified());
		return title;
	}
